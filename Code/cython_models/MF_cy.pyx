...
cdef class mf_trainer:
    ...
    def __init__(self, user_size, item_size, train_size, valid_size, test_size):
    ...
    cpdef train(self, train, valid, int dim_size, float r, float lr, int epoch_size, int desc_step, early_stopping):
        ...
        cdef double[:, :] I = np.random.rand(self.item_size, dim_size)
